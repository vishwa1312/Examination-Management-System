...
<body>
	...
	<div id="login">
		...
		<form action="admin_change.php" method="GET">

			<fieldset>
				<p><label for="email">Username</label></p>
				<p><input type="twxt" id="password" name='username' value="" onBlur="if(this.value=='')this.value='mail@address.com'" onFocus="if(this.value=='mail@address.com')this.value=''"></p> <!-- JS because of IE support; better: placeholder="mail@address.com" -->
...
if(($usrnme)==($username))
{
	...
	if(($new_pass) == ($con_pass))
	{
		...
		$result=mysqli_query($con,"Update admin set password='$new_pass' where username='$usrnme'");
		if (!$result)
		{
	...
	{echo '<a href="d.php"><p style="text-align:center">Username is wrong Re-enter Username</a>';
	echo '<a href="admin_menu1.html"><p style="text-align:center">Click here to go to main page</a>';}
}
?>
